  ...
  return (
    <>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-4xl">
          <h2 className="text-3xl font-semibold text-gray-900 dark:text-gray-100 mb-8">
            Who We Are <span className="text-gray-500 dark:text-gray-400 font-normal text-2xl">我们是谁</span>
          </h2>
          <div className="space-y-6 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
            <p>
              云玦科技 (Yunjue Technology) 是一家致力于构建自进化通用智能体 (Self-Evolving AGI) 的前沿科技公司。
            </p>
            <p>
              我们是一群不知疲倦的探索者，成员来自顶尖的 AI 实验室与工程团队。我们不满足于"静态"的大模型——那些被冻结在训练完成那一刻的参数矩阵。我们相信，真正的智能不在于存储了多少过去的知识，而在于面对未知未来时，适应、学习并创造工具的能力。
            </p>
            <p className="italic text-gray-600 dark:text-gray-400 text-base">
      ...
      <section className="py-16 md:py-24 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-4xl">
          <h2 className="text-3xl font-semibold text-gray-900 dark:text-gray-100 mb-8">
            Our Vision <span className="text-gray-500 dark:text-gray-400 font-normal text-2xl">愿景</span>
          </h2>
          <div className="space-y-6 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
      ...
      <section className="py-16 md:py-24 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-4xl">
          <h2 className="text-3xl font-semibold text-gray-900 dark:text-gray-100 mb-12">
            Our Philosophy <span className="text-gray-500 dark:text-gray-400 font-normal text-2xl">技术哲学</span>
          </h2>
      ...
      <section className="py-16 md:py-24 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-4xl">
          ...
          <Link
            href="/joinus"
            className="inline-block px-8 py-4 text-base font-medium text-white bg-gray-900 dark:bg-gray-100 dark:text-gray-900 rounded-md hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
          >
            查看职位 &rarr;
          </Link>
        </div>
