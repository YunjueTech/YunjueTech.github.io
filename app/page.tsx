    ...
    <>
      ...
      <Section eyebrow="我们做什么" title="一个能与你共同成长的智能体，而不是一面镜子">
        <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
          ...
          不打扰主意识流；云端 AI 是<strong>外置前额叶</strong>——把感官采集的信号转化为反思、回顾与决策支持，
          让智能体真正理解你这个人，并据此自动成长。
        </p>
      ...
      <Section eyebrow="从 Early Fusion 到 Human-Centric World Model" title="现在能做到什么，长期要去哪里">
        <div className="space-y-10">
          <div>
            ...
            <p className="mb-6 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
              ...
              时序关系与强度细节全部丢失。云玦在原始信号层对齐 7 种模态，结论精确到事件、瞬间、个人。
            </p>
          ...
          <div>
            ...
            <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
              ...
              <strong>以人为中心的多模态基础模型</strong>——把心率、IMU、声音、视觉、对话、画像、关系图谱
              在原始信号层对齐，建立一个真正理解"人"的世界模型，
              而不是通用互联网知识的压缩版。
            </p>
          </div>
        </div>
      ...
      <Section eyebrow="路线" title="三条赛道并行推进">
        <div className="space-y-4 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
          ...
          <p>
            ...
            上线，随身设备成为真正的外置感官系统；端侧 / 边侧分流方案就绪，原始数据"出不出端"由用户主动选择。
          </p>
          <p>
      ...
      <Section eyebrow="加入我们" title="我们在搭一支想要亲手打造未来的团队">
        <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
          硬件、端侧多模态、Realtime、自进化智能体、自训 Human-Centric World Model —— 每一条线我们都在找能独立扛起整条方向的人。
          欢迎 产品、 工程、 算法 的岗位投递。
        </p>
